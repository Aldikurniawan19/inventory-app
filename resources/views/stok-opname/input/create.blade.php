        ...
        <div class="card-body">
            @if($items->isEmpty())
                <div class="alert alert-info text-center" role="alert">
                    ...
                    <p class="mb-0">Silakan buat priode stok opname terlebih dahulu di menu <strong>Priode Stok Opname</strong> sebelum melakukan input laporan.</p>
                </div>
            @else
                <table class="table">
                    <thead>
