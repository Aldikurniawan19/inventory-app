<div class="card" style="width: auto;">
    <div class="card-body">
        <img src="{{ asset('storage/varian_produk/' . $varian->gambar_varian) }}" alt="{{ $varian->nama_varian }}"
        ...
        <x-meta-item label="Stok" value="{{ number_format($varian->stk_varian) }} pcs" />
    </div>
    <div class="card-footer d-flex justify-content-between align-items-center gap-1">
        <div class="w-100">
            <button type="button" class="btn btn-outline-primary btn-sm btnEditVarian" data-id="{{ $varian->id }}"
                ...
                data-stk-varian="{{ $varian->stk_varian }}"
