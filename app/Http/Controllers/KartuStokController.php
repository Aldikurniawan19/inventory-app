...
class KartuStokController extends Controller
{
    ...
    public function exportLaporan(Request $request)
    {
        ...
        $query = KartuStok::where('nomor_sku', $nomorSku)->where('jenis_transaksi', $jenisTransaksi)->whereBetween('created_at', [$tanggalAwal, $tanggalAkhir])->orderBy('created_at', 'DESC')->get();
