...
class KategoriProdukController extends Controller
{
    ...
    public function index(){
        ...
        confirmDelete('Hapus data kategori Produk Tidak dapat dibatalakn, Lanjutkan ?');
    ...
    public function store(storeKategoriProdukRequest $request){
        ...
        toast()->success('Kategori Produk Berhasil Di tambahkan');
    ...
    public function destroy(KategoriProduk $kategoriProduk){
        ...
        toast()->success('Kategori Produk Berhasil Di Hapus');
        return redirect()->route('master-data.kategori-produk.index');
    }
}
